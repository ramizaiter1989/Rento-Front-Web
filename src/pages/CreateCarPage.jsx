...
import { ArrowLeft, Car, Upload, MapPin, DollarSign, Settings, Image, FileText, Sparkles, Check, X, ExternalLink } from 'lucide-react';
...
export const CreateCarPage = () => {
  ...
  const openGoogleMapsForLocation = (field) => {
          ...
          <Card className="border-2 border-transparent hover:border-teal-500/30 transition-all duration-300 shadow-lg">
            <CardContent className="p-8">
              ...
              {['liveLocation', 'deliveryLocation', 'returnLocation'].map((field) => {
                ...
                const loc = formData[field];
                return (
                  <div key={field} className="mb-6 p-5 border rounded-lg bg-gray-50 dark:bg-gray-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          value={loc.address}
                          onChange={(e) => handleLocationChange(field, 'address', e.target.value)}
                          className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-teal-500 rounded-xl"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="52.5200"
                          value={loc.latitude || ''}
                          onChange={(e) => handleLocationChange(field, 'latitude', parseFloat(e.target.value) || 0)}
                          className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-teal-500 rounded-xl"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="13.4050"
                          value={loc.longitude || ''}
                          onChange={(e) => handleLocationChange(field, 'longitude', parseFloat(e.target.value) || 0)}
                          className="h-12 border-2 border-gray-200 dark:border-gray-700 focus:border-teal-500 rounded-xl"
                        />
                      </div>
                    </div>
                    {loc.latitude && loc.longitude && loc.latitude !== 0 && loc.longitude !== 0 && (
                      <Button
                        ...
                        size="sm"
                        className="mt-3"
                        onClick={() => openGoogleMapsForLocation(field)}
                      >
